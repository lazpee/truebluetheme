                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>Php $pro_price
...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_image,a.sellerid,a.product_desc,a.product_keywords,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
	}else{
		//When user is not logged in this query will execute
		$sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_image,a.sellerid,a.product_desc,a.product_keywords,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
	}
	$query = mysqli_query($con,$sql);
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
                    ...
                    <div class="product-widget">
												<div class="product-img">
													<img src="practice/'.$product_image.'" alt="">
												</div>
												<div class="product-body">
													<h3 class="product-name"><a href="#">'.$product_title.'</a></h3>
													<h4 class="product-price"><span class="qty">'.$n.'</span>Php'.$product_price.'</h4>
												</div>
						...
						<tr>
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-4 "><img src="practice/'.$product_image.'" style="height: 70px;width:75px;"/>
							...
							<td data-th="Quantity">
								<input type="text" name ="qty" class="form-control qty" value="'.$qty.'" >
							</td>
							<td data-th="Subtotal" class="text-center"><input type="text" class="form-control total" value="'.$product_price.'" readonly="readonly"></td>
							<td ><input type="hidden" class="form-control price" value="'.$sellerid.'" readonly="readonly"></td>
							...
							while($row=mysqli_fetch_array($query)){
								...
								echo  	
									...
									<input type="hidden" name="item_name_'.$x.'" value="'.$row["product_title"].'">
								     ...
								     <input type="hidden" name="sellerid_'.$x.'" value="'.$row["sellerid"].'">';
								}
