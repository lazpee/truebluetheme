				...
				<div class="row">
					...
					<?php 
                                ...
                                <div id="product-main-img">
                                    <div class="product-preview">
                                        <img src="practice/'.$row['product_image'].'" alt="">
                                    </div>
                                ...
                                <div id="product-imgs">
                                    ...
                                    <div class="product-preview">
                                        <img src="practice/'.$row['product_image'].'g" alt="">
                                    </div>
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Php '.$row['product_price'].'</h3>
								<span class="product-available">In Stock</span>
							</div>
							<p>'.$row['product_desc'].''.$row['product_keywords'].'</p>
							...
							<div class="add-to-cart">
								<div class="qty-label">
									...
									<div class="input-number">
										<input type="number" name ="qty" class="form-control qty" value="1" readonly="readonly">
							...
							<ul class="product-links">
								<li>Category:</li><li><a href="store.php">';
								$cat = $row['product_cat'];
							...
							$sql = " SELECT * FROM brands WHERE brand_id = $brand";
								if (!$con) {
									die("Connection failed: " . mysqli_connect_error());
								}
								$result = mysqli_query($con, $sql);
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12"><center>
											<p>Product Price: '.$row['product_price'].'<br>Stock/s: '.$row['stock'].'<br >Seller Name/Shop: ';
										}}
										$sql = " SELECT * FROM tbl_user WHERE id = $sellerid";
