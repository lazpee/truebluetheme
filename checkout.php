	...
	<script type="application/javascript">
		...
		$('#myselector').on ('change', function(){
			if ($(this).val()=='2') {
				...
				$('#expdate').attr('readOnly','readOnly');
	...
	<div class="container-fluid">
		...
		echo'
			<div class="col-75">
				...
				<form id="checkout_form" action="payment_success.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<input type="text" id="cname" name="cardname" class="form-control" pattern="^[a-zA-Z ]+$" placeholder="Example Visa" value = "none">
						
						<div class="form-group" id="card-number-field">
                        <label for="cardNumber">Card Number</label>
                        <input type="text" class="form-control" id="cardNumber" name="cardNumber" placeholder="00000" value = "00000">
                    </div>
						<label for="expdate">Exp Date</label>
						<input type="text" id="expdate" name="expdate" class="form-control" pattern="^((0[1-9])|(1[0-2]))\/(\d{2})$" placeholder="00/00" value = "12/22">
						<div class="row">
						<div class="col-50">
							<div class="form-group CVV">
								<label for="cvv">CVV</label>
								<input type="text" class="form-control" name="cvv" id="cvv"  value = "0000">
						</div>
						</div>
					</div>
					</div>
					...
					while($i<=$total_count){
						...
						<input type='hidden' name='sellerid_$i' value='$sellerid_'>
						";
						$i++;
					}
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="hidden" name="tx" value="'."TRANSID-".strtoupper(uniqid()).'">
					<input type="hidden" name="date" value="'.$date.'">
					<input type="hidden" name="sellerid" value="'.$sellerid_.'">
					<input type="submit" id="submit" name="st" value="Completed" class="checkout-btn">
				</form>
				</div>
			</div>
			';
